    ...
    <div class="container register-input-section d-none pt-5">
        <div class="row justify-content-center">
            <div class="login-page mt-5">
                ...
                <div class="login-title text-center">
                    <span style="font-size: 18px;">You are invited by {{ $sponsor->getFullname() }}</span>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <form class="form-section" data-form="register" autocomplete="off" method="POST" action="{{ route('register') }}">
                ...
                <div class="row mx-0 mt-4">
                        ...
                        <div class="login-page">
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <input type="text" class="form-control" id="mobileNumber" placeholder="Phone Number" tabindex="6">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="login-title info-title">
                                <span class="registration-email-lable">EMAIL ADDRESS</span>
                            </div>
                        </div>
                        <div class="login-page">
                            <div class="form-group">
                ...
                <div class="row mt-4 mx-0">
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            ...
                            <div class="form-group">
                                <input type="text" name="city" class="form-control" id="city" placeholder="City" tabindex="10">
                                <!-- <input type="text" class="form-control" id="city" placeholder="City" tabindex="10" onchange="changeCity()"> -->
...
@section('PAGE_LEVEL_SCRIPTS')
    <script type="text/javascript">
        ...
        $('.select-type').on('click', function() {
            ...
            if (user_type == 0) {
                $('.registration-title').html('REGISTRATION');
