...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="background:#fff none no-repeat center/cover;height: 100%;margin: 0;padding: 0;width: 100%;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #fff;background-image: none;background-repeat: no-repeat;background-position: center;background-size: cover;">
    <center>
      <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" id="bodyTable" style="height:100%;background:#fff none no-repeat;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;padding:0;width:100%;background-color:#fff;background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;">
        <tr>
            ...
            <table align="center" border="0" cellspacing="0" cellpadding="0" width="600" style="width:600px;">
              <tr>
                <td align="center" valign="top" width="600" style="width:600px;">
                  <![endif]-->
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;border:0;max-width:600px !important;">
              <tr>
                      ...
                      <tr>
                        <td valign="top" class="mcnTextBlockInner" style="padding-top:0px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
                          ...
                          <td valign="top" width="600" style="width:600px;">
                            <![endif]-->
                          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%;min-width:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background-color:#04246b;background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;" width="100%" class="mcnTextContentContainer">
                            <tbody>
                              <tr>
                    ...
                    <tbody class="mcnTextBlockOuter">
                      <tr>
                        <td class="mcnTextBlockInner" style="padding-top:0px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;" valign="top">
                          ...
                          <td valign="top" width="600" style="width:600px;">
                            <![endif]-->
                          <table style="max-width:100%;min-width:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background-color:#216be9;background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                <td class="mcnTextContent" style="padding:30px; mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-family: DinPro Light, sans-serif;color:#ffffff;text-align:left;" valign="top">
                                  ...
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">Take your time to connect with other <b>VENTURA</b> and try all the features we have developed.</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td class="mcnTextContent" style="padding:30px; mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-family: DinPro Light, sans-serif;color:#ffffff;text-align:left;" valign="top">
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">At <b>VENTURA</b>, we respect your privacy, so we will never share your data with external companies. Please keep in mind that we build this community with respect for each other.</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">We recommend you to login and visit the INFO section first as this will explain you in detail on how everything works.</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">Please follow our daily NEWS channel for any updates and instructions.</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">“If we can positively touch the lives of a few, So they can positively touch the lives of a few, We are on the right path to serve the many!”</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">Thank you for joining the <b>VENTURA</b> test group.</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:25px;">Let's connect and have some fun together.</p>
                                  <p style="font-size: 14px; color:white; margin-bottom:5px;">Your <b>VENTURA</b> support team</p>
                                </td>
                              </tr>
                              <tr>
                                <td class="mcnTextContent" style="padding:30px; padding-bottom: 50px; mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff;text-align:center;" valign="top">
                                  <a href="{{ route('login') }}" style="background:#04246b; text-decoration:none; color:white; font-size:14px; border-radius: 10rem; font-family: DinPro Light, sans-serif; padding-left:100px; padding-right:100px; padding-top:10px; padding-bottom:10px;">LOGIN</a>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <td valign="top" class="mcnTextBlockInner" style="padding-top:0px;mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
                          ...
                          <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%;min-width:100%;border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background-color:#04246b;background-image:none;background-repeat:no-repeat;background-position:center;background-size:cover;" width="100%" class="mcnTextContentContainer">
                            <tbody>
                              ...
                              <tr>
                                <td class="mcnTextContent" style="padding:30px; mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff;text-align:center;" valign="top">
                                  <p style="font-family: DinPro Light, sans-serif;font-size:12px; color:#ffffff;text-align: center;">If you don't wish to receive future community emails, click here: <span style="color:#216be9; text-decoration:none;">unsubscribe</span></p>
                                </td>
                              </tr>
                            </tbody>
                          </table>
