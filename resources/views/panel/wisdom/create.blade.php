  ...
  <div class="row m-0 p-0 w-100 posts-section">
    <div class="row justify-content-center m-0 py-3 w-100">
      <div class="col-md-6 p-0">
        <div class="text-center pb-3 create-title">CREATE A POST</div>
        ...
        <div class="post-top-content">
          <div class="title story-title editable" contenteditable="true">Wisdom Title</div>
        </div>
        <div class="w-100">
        ...
        <div class="post-content">
          <div class="title story-subject editable" contenteditable="true">Wisdom Title</div>
          <div class="content story-content editable" contenteditable="true">Write some words of wisdom.</div>
        </div>
