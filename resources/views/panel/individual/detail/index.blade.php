            ...
            <form class="form-section" data-form="register" autocomplete="off" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="login-page">
                            ...
                            <label class="checkbox-container">
                                    <input type="radio" name="gender" {{ $user->profile->gender == 'f' ? 'checked' : '' }} id="gender-female" value="f"/>
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('FEMALE') }}</span>
                                </label>
                                <label class="checkbox-container pl-5">
                                    <input type="radio" name="gender" id="gender-male" {{ $user->profile->gender == 'm' ? 'checked' : '' }} value="m"/>
                                    <span class="checkbox-circle"></span>
                ...
                <div class="row mx-0 mt-4">
                        ...
                        <div class="login-page">
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <input type="text" class="form-control" id="mobileNumber" placeholder="Phone Number" tabindex="6" value="{{ explode(" ", $user->profile->phone)[1] }}" readonly>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="login-page">
                            <div class="form-group">
                                <input type="email" name="email" class="form-control" id="email" placeholder="Email" tabindex="7" value="{{ $user->email}}" readonly>
                ...
                <div class="row mt-4 company-details-section mx-0">
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="text" name="company_name" class="form-control" id="companyName" placeholder="Company Name" tabindex="4" value="{{ $user->profile->company_name}}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="text" name="site_url" class="form-control" id="vatNumber" placeholder="Website" tabindex="5" value="{{ $user->profile->site_url}}" readonly>
                ...
                <div class="row mt-4 mx-0">
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="text" name="street_name" class="form-control" id="streetName" placeholder="Street" tabindex="8" value="{{ $user->profile->street}}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="text" name="house_number" class="form-control" id="houseNumber" placeholder="House Number" tabindex="9" value="{{ $user->profile->house_number}}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="text" name="postal_code" class="form-control" id="postalCode" placeholder="Postal Code" tabindex="11" value="{{ $user->profile->postal_code}}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <input type="text" name="city" class="form-control" id="real-city" placeholder="City" hidden value="{{ isset($user->profile->city) ? $user->profile->city : '' }}">
                            <div class="form-group search-city">
                                <input type="text" class="form-control" id="city" placeholder="City" tabindex="10" value="{{ empty($cityname) ? isset($user->profile->city) ? $user->profile->city : 'City' : $cityname }}" readonly>
                ...
                <div class="row mt-4 mx-0">
                    ...
                    <div class="col-md-6">
                        <div class="login-page">
                            <div class="form-group">
                                <input type="password" name="password" class="form-control" id="password" placeholder="Password" tabindex="15" readonly>
                    ...
                    <div class="login-page">
                        <div class="form-group row justify-content-center pb-5">
                            <div class="col-12 text-center">
                                 <a class="btn btn-primary login-button d-flex justify-content-center align-items-center" href="{{ route('profile.detail.edit') }}">
                                    {{ __('EDIT') }}
                                 </a>
                            </div>
                        </div>
