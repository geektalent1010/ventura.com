        ...
        <div class="row justify-content-center">
            <div class="login-page mt-5">
                <div class="login-title text-center">
                    <p class="mb-1" style="font-size: 18px;">ADD A COMPANY</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <form class="form-section" data-form="register" autocomplete="off" method="POST" action="{{ route('add.company') }}">
                @if ($errors->any())
                        ...
                        <div class="login-page">
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <input type="text" class="form-control" id="mobileNumber" placeholder="Phone Number" tabindex="2">
                                </div>
                    ...
                    <div class="col-md-6" style="margin-bottom:1rem;">
                        <div class="login-page h-100">
                            <div class="form-group h-100">
                                <textarea class="form-control" class="companyProduct" id="companyProduct" name="products" placeholder="Products / Services" tabindex="3"></textarea>
    ...
    <script type="text/javascript">
        ...
        const register = {
            ...
            variables: function () {
                ...
                this.companyProductsInput = $('#companyProducts');
                this.companyProductsError = $('#company-products-error');
            ...
            addEventListeners: function () {
                ...
                this.companyProductsInput.on('keyup', function () {
                    this.validateCompanyProductsInput();
                }.bind(this));
            ...
            validateCompanyProductsInput: function () {
                var validationMessage = '';
                var value = this.companyProductsInput.val();
                ...
                if ((/^[a-zA-Z\-0-9 ]{2,50}$/.test(value)) || (/^[\p{L}\d\- ]{2,50}$/u.test(value))) {
                    validationMessage = 'Now, that\'s a good company product.\n';
                    this.companyProductsError.addClass('valid');
                    this.companyProductsError.hide();
                } else if (value === '') {
                    validationMessage = 'The company products field is required.';
                    this.companyProductsError.removeClass('valid');
                    this.companyProductsError.show();
                } else {
                    validationMessage = 'The company products must contain only letter and be minimum of 2 characters.';
                    this.companyProductsError.removeClass('valid');
                    this.companyProductsError.show();
                }

                this.companyProductsError.html(validationMessage);
                this.scrollToError = this.companyNameInput;
