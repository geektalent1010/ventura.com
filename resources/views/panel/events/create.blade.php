    ...
    <div class="row justify-content-center m-0 py-3 w-100">
      <div class="col-md-6 p-0">
        ...
        <div class="post-content">
          <div class="title event-subject editable" contenteditable="true">Event Name</div>
          <div class="content event-content editable" contenteditable="true">Write about this event.</div>
        </div>
